...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    xmlns:utils="http://aac.ac.at/content_repository/utils" xmlns:saxon="http://saxon.sf.net/"
    ...
    <xd:doc>
        <xd:desc>Generate a valid XHTML 1 DOCTYPE and handle some HTML cornercasees. <xd:p>Note:
                method="xhtml" is saxon-specific! prevents collapsing empty &lt;script&gt; tags,
                that makes browsers choke (eg. not loading that script), but collapses &lt;br&gt;
                tags which might otherwise be interpreted as two.</xd:p>
            <xd:p>Note: saxon checks the namespace of the script and br tags so to make this magic
                work it's essential the tags to have xmlns="http://www.w3.org/1999/xhtml". This
                might be achieved by setting this as the default namespace like in this script or
                otherwise. </xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xd:doc>
        <xd:desc>Inserts the JavaScript funtions needed for displaying the representation of the
            unknown parts of the TEI encoding.</xd:desc>
    </xd:doc>
