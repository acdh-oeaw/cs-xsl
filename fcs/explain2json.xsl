...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc> generate a json object of the explain <xd:p>Output</xd:p>
            <xd:pre>
    ...
    <xd:doc>
        <xd:desc> Generate JSON for one indexInfo Item <xd:p>sample data:</xd:p>
            <xd:pre>
            &lt;sru:term&gt;
