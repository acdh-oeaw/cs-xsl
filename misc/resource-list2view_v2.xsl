...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:template match="teiHeader" mode="record-data">
        <p>
            <xsl:apply-templates select=".//sourceDesc/bibl[@type = 'transcript']"
                mode="record-data"/>
        </p>
    ...
    <xsl:template match="cmd:CMD" mode="record-data">
        ...
        <!--        <xsl:apply-templates select=".//sourceDesc//imprint" mode="record-data"/>-->
        <xsl:apply-templates select=".//cmd:sourceDesc//cmd:msDesc" mode="record-data"/> s <!--        <xsl:apply-templates select=".//cmd:TotalSize" mode="record-data"/>-->
        <div class="div-after"/>
    </xsl:template>
</xsl:stylesheet>
